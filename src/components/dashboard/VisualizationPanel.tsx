  ...
  return (
    <div>
      <div className="flex items-center gap-3 mb-3">
        <span className="text-[10px] font-bold mono" style={{ color: "#e97b2c" }}>{num}</span>
        <span className="text-[10px] font-medium uppercase tracking-wider" style={{ color: "#9ca3af" }}>{label}</span>
        <div className="flex-1 h-px" style={{ backgroundColor: "#f0ebe4" }} />
      </div>
      <div className="rounded-lg overflow-hidden bg-white border border-[#e8ddd0]" style={{ boxShadow: "0 1px 3px rgba(0,0,0,0.04)" }}>
        {children}
      </div>
    </div>
  );
